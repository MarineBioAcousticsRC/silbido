...
% Caveats:  
%
% This routine is implemented in C/C++ and must be compiled with: 'mex
% stMA'.  You must have a C/C++ compiler installed to compile this.  Free
% C/C++ compilers are available for a variety of platforms.  Most linux/unix
% platforms come with the appropriate compilers, Microsoft offers a free
% version of their VisualStudio C/C++ (community edition) compiler for
% Windows.
%  

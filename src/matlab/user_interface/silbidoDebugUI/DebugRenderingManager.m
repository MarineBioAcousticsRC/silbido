classdef DebugRenderingManager < handle
   properties
      ...
      % The type of filter bank displayed (linear or constant-Q).
      filterBank;
   end % properties
   
   methods
      function cb = DebugRenderingManager(handles, thr, varargin)
          cb.handles = handles;
          cb.thr = thr;
      ...
      function handleActiveSetExtension(cb, tt)
          ...
          elseif (strcmp(cb.filterBank, 'constantQ'))
              cb.active_set_peak_handles = plot(...
                  cb.handles.spectrogram,...
                  active_set.getActiveSet().get_time(), ...
                  log10(active_set.getActiveSet().get_freq), ...
                  'g*');
          end
          ...
          elseif (strcmp(cb.filterBank, 'constantQ'))
              cb.orphan_set_peak_handles = plot(...
                  cb.handles.spectrogram, ...
                  active_set.getOrphanSet().get_time(), ...
                  log10(active_set.getOrphanSet().get_freq), ...
                  'y*');
          end
      ...
      % TODO: Integrate plotFits with constant-Q.

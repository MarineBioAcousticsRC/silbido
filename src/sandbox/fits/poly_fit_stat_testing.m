...
for i = 1:5
    ...
    [ssTot, ssRes, ssReg, R2, R2_ADJ, sdRes ] = polyfit_eval(times, freqs, p);
    ...
    R2_1 = fp1.getR2();
    R2_ADJ_1 = fp1.getAdjustedR2();
    ssTot_1 = fp1.getTotalSumOfSquares();
    ssRes_1 = fp1.getResidualsSumOfSquares();
    ssReg_1 = fp1.getRegressionSumOfSquares();
    sdRes_1 = fp1.getStdDevOfResiduals();
    
    next_freq1 = fp1.predict(next_time);
    scatter(next_time,next_freq1, strcat(colors(i), '^'));
    
   
    % New Fit Poly based on Jama
    fp2 = tonals.FitPolyJama(i, times_v, freqs_v);
    R2_2 = fp2.getR2();
    R2_ADJ_2 = fp2.getAdjustedR2();
    ssTot_2 = fp2.getTotalSumOfSquares();
    ssRes_2 = fp2.getResidualsSumOfSquares();
    ssReg_2 = fp2.getRegressionSumOfSquares();
    sdRes_2 = fp2.getStdDevOfResiduals();
    
    next_freq2 = fp2.predict(next_time);
    scatter(next_time,next_freq2, strcat(colors(i), '+'));
    
    
    % New Fit Poly based on Commons Math
    fp3 = tonals.FitPolyCommons(i, times_v, freqs_v);
    R2_3 = fp3.getR2();
    R2_ADJ_3 = fp3.getAdjustedR2();
    ssTot_3 = fp3.getTotalSumOfSquares();
    ssRes_3 = fp3.getResidualsSumOfSquares();
    ssReg_3 = fp3.getRegressionSumOfSquares();
    sdRes_3 = fp3.getStdDevOfResiduals();

function bictest3(SourceData, varargin)
% bictest(SourceData, OptionalArguments)
% Evaluate the BIC on a corpus
%
% USE REGRESSION FOR PEAK PICKING
%
% Optional arguments
...
switch runenv
 case 'dusky'
      ...
      if Display
         ...
         outPath = '/zal/cheng/matlab/audio/tracking/automation/results24/regression/';   
      end
...
if noEnd
    outFile= strcat(outPath,MethodName, '_', ...
                    ...
                    num2str(EnergyPct), Bayesian,'reg_ne.txt');
else
    outFile= strcat(outPath,MethodName, '_', ...
                    num2str(WindowLengthMS/1000), '_',...
                    num2str(WindowAdvanceMS/1000),'_',...
                    num2str(EnergyPct), Bayesian, 'reg.txt');
end
out = fopen(outFile,'w');

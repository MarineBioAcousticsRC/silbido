...
public class FitPoly
{
	 ...
	 *         dimension of the data arrays
	 */
	public FitPoly(int order, double [] x, double [] y,
			double [] sigma_x, double [] sigma_y, int num_points) {
	 ...
	 */
	public FitPoly(int order, Vector<Double> x, Vector<Double> y) {
	...
	public FitPoly(int order, tonal tone, int skip_n, boolean fit_dphase,
	 ...
	 * @param y - actual value
	  */
	 public double sq_error(double x, double y) {
		 double error = y - predict(x);
		 return error*error;
	 }
